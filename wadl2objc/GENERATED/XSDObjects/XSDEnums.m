...
@property(nonatomic, strong) NSDictionary *PermissionDictionary;
...
@property(nonatomic, strong) NSDictionary *SkuDetailTypeDictionary;
...
- (id)init
{
    ...
    if (self) {
		...
		_AuthResponseTypeDictionary = @{ @(AuthResponseTypeAPPROVED) : kAuthResponseTypeAPPROVEDString, @(AuthResponseTypeDECLINED) : kAuthResponseTypeDECLINEDString, @(AuthResponseTypeDECLINED_REFERRED) : kAuthResponseTypeDECLINED_REFERREDString, @(AuthResponseTypeREFERRED) : kAuthResponseTypeREFERREDString, @(AuthResponseTypePARTIAL) : kAuthResponseTypePARTIALString, @(AuthResponseTypeREVERSAL_FAILED) : kAuthResponseTypeREVERSAL_FAILEDString, @(AuthResponseTypeREVERSAL_PASSED) : kAuthResponseTypeREVERSAL_PASSEDString, @(AuthResponseTypeUNKNOWN) : kAuthResponseTypeUNKNOWNString };
		...
		_BrandDictionary = @{ @(BrandTMW) : kBrandTMWString, @(BrandJABN) : kBrandJABNString, @(BrandJABO) : kBrandJABOString, @(BrandJABU) : kBrandJABUString, @(BrandJABF) : kBrandJABFString, @(BrandMWTUX) : kBrandMWTUXString, @(BrandMWOUT) : kBrandMWOUTString, @(BrandMCY) : kBrandMCYString, @(BrandUNKNOWN) : kBrandUNKNOWNString };
		...
		_ClientTypeDictionary = @{ @(ClientTypeMACYS) : kClientTypeMACYSString, @(ClientTypeTUXMOBIL) : kClientTypeTUXMOBILString, @(ClientTypeTXONLINE) : kClientTypeTXONLINEString, @(ClientTypeDASHBOARD) : kClientTypeDASHBOARDString, @(ClientTypeSERVER_JOB) : kClientTypeSERVER_JOBString };
		...
		_PermissionDictionary = @{ @(PermissionPF_SIGNUP_DISABLED) : kPermissionPF_SIGNUP_DISABLEDString, @(PermissionCUSTOMER_SEARCH_DISABLED) : kPermissionCUSTOMER_SEARCH_DISABLEDString, @(PermissionPAYMENT_SCREEN_DISABLED) : kPermissionPAYMENT_SCREEN_DISABLEDString, @(PermissionFIND_YOUR_STYLE_DISABLED) : kPermissionFIND_YOUR_STYLE_DISABLEDString, @(PermissionVIEW_SKU_DETAILS) : kPermissionVIEW_SKU_DETAILSString, @(PermissionFIT_QUESTIONNAIRE_ENABLED) : kPermissionFIT_QUESTIONNAIRE_ENABLEDString };
		...
		_SkuDetailTypeDictionary = @{ @(SkuDetailTypeRENTAL) : kSkuDetailTypeRENTALString, @(SkuDetailTypeDEPOSIT) : kSkuDetailTypeDEPOSITString, @(SkuDetailTypeDAMAGE_HANDLING) : kSkuDetailTypeDAMAGE_HANDLINGString, @(SkuDetailTypeRUSH_FEE) : kSkuDetailTypeRUSH_FEEString, @(SkuDetailTypeCHANGE_ORDER_FEE) : kSkuDetailTypeCHANGE_ORDER_FEEString, @(SkuDetailTypeCANCELLATION_FEE) : kSkuDetailTypeCANCELLATION_FEEString, @(SkuDetailTypeLATE_FEE) : kSkuDetailTypeLATE_FEEString, @(SkuDetailTypeLOST_ITEM_FEE) : kSkuDetailTypeLOST_ITEM_FEEString, @(SkuDetailTypeRETAIL_ITEM) : kSkuDetailTypeRETAIL_ITEMString, @(SkuDetailTypeUNRESOLVED) : kSkuDetailTypeUNRESOLVEDString };
		...
		_TenderTypeDictionary = @{ @(TenderTypeCREDIT_CARD) : kTenderTypeCREDIT_CARDString, @(TenderTypeCASH) : kTenderTypeCASHString, @(TenderTypeGIFT_CARD) : kTenderTypeGIFT_CARDString, @(TenderTypeDEBIT_CARD) : kTenderTypeDEBIT_CARDString, @(TenderTypeACCOUNTS_RECEIVABLE) : kTenderTypeACCOUNTS_RECEIVABLEString };
