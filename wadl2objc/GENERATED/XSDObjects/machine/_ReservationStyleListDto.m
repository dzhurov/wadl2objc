...
+ (NSArray*)mappedKeys
{
    ...
    if ( !keys ){
        keys = [@[@"reservationStyleDtoList", @"additionalAllowedStyles", @"estimatedCost", @"discountAmount", @"amountDue", @"hatPackageCode", @"messages"] arrayByAddingObjectsFromArray:[super mappedKeys]];
    }
    return keys;
}
