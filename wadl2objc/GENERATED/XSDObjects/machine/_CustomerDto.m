...
+ (NSArray*)mappedKeys
{
    ...
    if ( !keys ){
        keys = [@[@"id", @"perfectFitId", @"partyId", @"firstName", @"lastName", @"phoneNumber", @"email", @"address", @"city", @"stateCode", @"zip", @"birthday", @"usageCode", @"doNotContactModes"] arrayByAddingObjectsFromArray:[super mappedKeys]];
    }
    return keys;
}
